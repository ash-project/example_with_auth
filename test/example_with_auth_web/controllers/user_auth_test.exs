defmodule ExampleWithAuthWeb.UserAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ExampleWithAuthWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "log_in_user/3" do
    test "stores the user token in the session", %{conn: conn, user: user} do
      ...
      assert ExampleWithAuth.Accounts.User
  ...
  describe "logout_user/1" do
    test "erases session and cookies", %{conn: conn, user: user} do
      ...
      refute ExampleWithAuth.Accounts.User
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ExampleWithAuthWeb.Endpoint.subscribe(live_socket_id)
